...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'livinglots_groundtruth_groundtruthrecord', (
        ...
        db.send_create_signal(u'livinglots_groundtruth', ['GroundtruthRecord'])


    def backwards(self, orm):
        # Deleting model 'GroundtruthRecord'
        db.delete_table(u'livinglots_groundtruth_groundtruthrecord')
    ...
    models = {
        ...
        u'livinglots_groundtruth.groundtruthrecord': {
    ...
    complete_apps = ['livinglots_groundtruth']